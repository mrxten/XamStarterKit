...
namespace XamStarterKit.Layouts {
    public class KitLayout<T> : Layout<View> {
        ...
        public static readonly BindableProperty ViewTypeProperty =
            BindableProperty.CreateAttached(@"ViewType", typeof(T), typeof(KitLayout<T>), default(T));
        ...
        public KitLayout<T> Add(T type, View view) {
        ...
        public KitLayout<T> Add(params Tuple<T, View>[] views) {
